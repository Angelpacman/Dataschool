...
# Es un hecho que para hacer esto lo que debemos saber previeamente es el tipo de variable que tiene cada columna y cambiarla segun sea el caso y desde luego, asegurarnos de que el cambio del tipo de objeto es cambiable.
# 
...
# El siguiente ejemplo tiene muchas aplicaciones, vamos a convertir una serie de booleanos no solo para filtrar el data frame sino para convertirlo en ceros y unos, esto puede usarde en una matriz de machine learning y ver que filas contienen o no una caracteristica de nuestro interes pasandole a la matriz los numeros que los definen:
